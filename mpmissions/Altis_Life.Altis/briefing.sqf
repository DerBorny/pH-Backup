...
player createDiarySubject ["controls","Hotkeys"];
...
*/
	player createDiaryRecord["changelog",
		[
			"Offizieller Changelog",
				"
					06.02.15 - Meth, XTC und Meskalin als neue Drogen eingefügt<br/>
					07.02.15 - Open Beta gestartet<br/>
					08.02.15 - div. Bugfixes, 2 neue Berufe (Kohle & Mohnbrötchen)<br/>
					09.02.15 - überarbeitung des Schießstandes, Umzug vom Cop-AirHQ zur Airbase
	...
	player createDiaryRecord["changelog",
		...
		[
			"Serverregeln", 
				"
				Jeder der Cheatet und/oder sich anderweitig Bugs ausnutzt um sich einen vorteil zu verschaffen, wird gebannt! <br/><br/>

				1. Safezones sind Safezones und dort dürfen keine Spieler angegriffen oder ausgeraubt werden!<br/>
				2. RP-Flucht (heißt aus einer Situation durch Selbst-Kill oder Disconnect flüchten) wird ebenfalls mit einem Ban bestraft!<br/>
				3. Sei kein Idiot, sei fair zu jedem und halte dich an die Regeln um für jeden den Spielspaß zu gewährleisten<br/>
				4. Nur weil ein Hacker drauf war und Fahrzeuge/Waffen gespawnt hat, heißt das nicht das ihr es behalten könnt, nur weil ihr nicht gemogelt habt ;)<br/>
				5. Fehler/Bugs bitte an die Admins melden, nicht wissentlich ausnutzen<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["safezones",
		[
			"Safe Zones",
				"
					Das explodieren lassen von Fahrzeugen, ausrauben und töten von Spielern ist in folgenden Bereichen strikt untersagt:<br/><br/>
					
					Markierte Safezones<br/>
					JEDER ATM<br/>
					Alle Polizei Hauptquartiere<br/>
					Banditenaußenposten<br/>
					Donator Shops<br/><br/>
				"
		]
	];
...
// Controls Section
	...
	player createDiaryRecord ["controls",
		[
			"",
				"
				z: Öffnet Spielermenü<br/>
				U: Fahrzeug auf/zu schließen)<br/>
				F: Polizeisiren (wenn Cop)<br/>
				K: Polizei EMP (wenn Cop)<br/>
				T: Fahrzeuginventar<br/>
				SHIFT + R: Fesseln (wenn Cop)<br/>

...
switch (_var) do
{
	...
	case "life_inv_baeckerei": {(localize "STR_Item_Baeckerei")};
	case "life_inv_kohle_roh": {(localize "STR_Item_Kohle_Roh")};
	case "life_inv_kohle_fertig": {(localize "STR_Item_Kohle_Fertig")};
	...
	case "life_inv_meth_r": {(localize "STR_Item_MethR")};
	case "life_inv_meskalin": {(localize "STR_Item_Meskalin")};
	case "life_inv_meskalin_r": {(localize "STR_Item_MeskalinR")};
	case "life_inv_xtc": {(localize "STR_Item_XTC")};
	case "life_inv_xtc_r": {(localize "STR_Item_XTCR")};
	...
	case "license_civ_baeckerei": {(localize "STR_License_Baeckerei")};
	...
	case "license_admin": {(localize "STR_License_Admin")};
	...
	case "license_civ_kohle": {(localize "STR_License_Kohle")};
	case "license_civ_meth": {(localize "STR_License_Meth")};
	case "license_civ_xtc": {(localize "STR_License_XTC")};
	case "license_civ_meskalin": {(localize "STR_License_Meskalin")};

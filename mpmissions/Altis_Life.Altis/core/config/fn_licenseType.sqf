...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "admin": {_var ="license_admin"};
			case "heroin": {_var = "license_civ_heroin"}; //Heroin processing license cost
			case "baeckerei": {_var = "license_civ_baeckerei"}; // Baeckerei
			...
			case "kohle_lic": {_var = "license_civ_kohle"};
			case "meth": {_var = "license_civ_meth"};
			case "xtc": {_var = "license_civ_xtc"};
			case "meskalin": {_var = "license_civ_meskalin"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_admin": {_var = "admin"};
            case "license_adac_air": {_var = "air"};
			case "license_civ_coke": {_var = "cocaine"};
			case "license_civ_kohle": {_var = "kohle_lic"};
			case "license_civ_meth": {_var = "meth"};
			case "license_civ_xtc": {_var = "xtc"};
			case "license_civ_meskalin": {_var = "meskalin"};

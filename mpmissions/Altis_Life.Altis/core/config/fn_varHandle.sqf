...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "baeckerei": {"life_inv_baeckerei"}; 
			...
			case "meth_r": {"life_inv_meth_r"};
			case "xtc": {"life_inv_xtc"};
			case "xtc_r": {"life_inv_xtc_r"};
			case "meskalin": {"life_inv_meskalin"};
			case "meskalin_r": {"life_inv_meskalin_r"};
			case "cocainep": {"life_inv_cokep"};
			case "kohle_roh": {"life_inv_kohle_roh"};
			case "kohle_fertig": {"life_inv_kohle_fertig"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_kohle_roh": {"kohle_roh"};
			case "life_inv_kohle_fertig": {"kohle_fertig"};
			case "life_inv_meth": {"meth"};
			case "life_inv_meth_r": {"meth_r"};
			case "life_inv_xtc": {"xtc"};
			case "life_inv_xtc_r": {"xtc_r"};
			case "life_inv_meskalin": {"meskalin"};
			case "life_inv_meskalin_r": {"meskalin_r"};

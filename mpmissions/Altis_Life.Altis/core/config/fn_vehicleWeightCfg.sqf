...
switch (_className) do
{
	...
	case "B_Truck_01_box_F": {1450};
	case "B_Truck_01_transport_F": {325};
	case "B_MRAP_01_F": {65};
	case "O_MRAP_02_F": {60};
	case "I_MRAP_03_F": {58};
	case "B_Heli_Light_01_F": {120};
	case "O_Heli_Light_02_unarmed_F": {290};
	case "I_Heli_Transport_02_F": {1250};
	case "I_Heli_light_03_F": {850};
	case "I_Heli_light_03_unarmed_F": {850};
	case "C_Rubberboat": {75};
	case "O_Boat_Armed_01_hmg_F": {175};
	case "B_Boat_Armed_01_minigun_F": {175};
	case "I_Boat_Armed_01_minigun_F": {175};
	case "B_G_Boat_Transport_01_F": {750};
	case "B_Boat_Transport_01_F": {750};
	...
	case "B_Heli_Transport_03_F": {4000};
	default {-1};
};
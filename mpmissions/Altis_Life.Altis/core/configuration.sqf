...
life_respawn_timer = 0.30; //Scaled in minutes
life_knockout = false;
...
*****************************
*/
life_maxWeight = 48; //Identifies the max carrying weight (gets adjusted throughout game when wearing different types of clothing).
life_maxWeightT = 48; //Static variable representing the players max carrying weight on start.
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["cocaine",1500],["cocainep",3500],["xtc",5500],["xtc_r",5500],["marijuana",2000],["meskalin",4500],["meskalin_r",1500],["turtle",3000],["blastingcharge",10000],["boltcutter",500]];
